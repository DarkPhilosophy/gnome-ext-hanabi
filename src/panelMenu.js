...
export class HanabiPanelMenu {
     ...
     */
    _setNextWallpaper = () => {
        const changeWallpaperDirectoryPath = this._settings.get_string('change-wallpaper-directory-path');
        let videoPaths = [];
        ...
        const currentIndex = videoPaths.findIndex(videoPath => videoPath === currentVideoPath);
        let nextIndex = 0;
        if (currentIndex !== -1)
